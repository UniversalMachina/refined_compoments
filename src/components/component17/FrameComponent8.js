...
const FrameComponent8 = ({ className = "" }) => {
  ...
  const contentData = {
    mainHeading: "Looking for a social media wizard",
    subHeading: [
      "Reach out to new people and engage with your",
      "prospects the personalized way",
    ],
  };
