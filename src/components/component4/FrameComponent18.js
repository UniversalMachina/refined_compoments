...
const FrameComponent18 = () => {
  ...
  return (
    ...
    >
      <div className="w-full bg-customColor-100 text-customColor-300 overflow-hidden flex flex-row items-center justify-center py-[141px] px-[147px] box-border min-h-[553px] max-w-full mq900:pl-9 mq900:pr-9 mq900:box-border mq1300:pl-[73px] mq1300:pr-[73px] mq1300:box-border">
