...
const FrameComponent23 = () => {
  ...
  const contentData = {
    mainHeading: "Lorum",
    mainDescription1: `Reach out to new people and engage with your prospects the personalized way Reach out to new people and engage with your prospects the personalized way Reach out to new people and engage with your prospects the personalized way Reach out to new people and engage with your prospects the personalized way`,
    mainDescription2: `Reach out to new people and engage with your prospects the personalized way Reach out to new people and engage with your prospects the personalized way`,
    statistics: [
      {
        value: "32+",
        description: "Reach out to new people",
      },
      {
        value: "32+",
        description: "Reach out to new people",
          ...
          <div className="w-[1395px] flex flex-col items-start justify-start gap-[19px] max-w-full">
            ...
            <div className="w-[778px] flex flex-row items-start justify-start gap-[74px] max-w-full mq900:flex-wrap">
              <div className="flex-1 flex flex-col items-start justify-start gap-[36px] min-w-[140px] mq900:flex-1">
                ...
                <b className="self-stretch text-customColor-300 relative text-[28.1px] font-dm-sans mq450:text-[22px]">{`Learn More >`}</b>
              </div>
