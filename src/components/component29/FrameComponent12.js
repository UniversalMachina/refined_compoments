...
const FrameComponent12 = ({ className = "" }) => {
  ...
  const contentData = {
    heading: "What Benefit Will You Get",
    benefits: [
            ...
            <div className="self-stretch flex flex-row items-start justify-start gap-[26.6px] max-w-full text-[24px] mq900:flex-wrap">
              ...
              <div className="flex-1 flex flex-col items-start justify-start pt-[1.4px] px-0 pb-0 box-border min-w-[363px] max-w-full mq450:min-w-full">
                <div className="self-stretch flex flex-col items-start justify-start gap-[42.6px] max-w-full">
                  ...
                  <div className="w-48 relative leading-[40px] font-medium inline-block mq450:text-[19px] mq450:leading-[32px]">
                    {contentData.benefits[1]}
                  </div>
                  <div className="w-[405.3px] relative leading-[40px] font-medium inline-block max-w-full mq450:text-[19px] mq450:leading-[32px]">
                    {contentData.benefits[2]}
                  </div>
                  <div className="w-[377.3px] relative leading-[40px] font-medium inline-block max-w-full mq450:text-[19px] mq450:leading-[32px]">
                    {contentData.benefits[3]}
                  </div>
                  <div className="w-[246.7px] relative leading-[40px] font-medium inline-block mq450:text-[19px] mq450:leading-[32px]">
